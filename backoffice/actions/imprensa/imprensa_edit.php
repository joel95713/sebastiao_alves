...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST["titulo"], $_POST["texto"], $_POST["imagem"])) {
    ...
    if (isset($_POST["editar_id"])) {
      ...
      iduSQL("UPDATE imprensa SET titulo = '$titulo', texto = '$texto', imagem = '$imagem', UpdatedOn = '$data_atual',  UpdatedBy = '$UpdatedBy', data_noticia = '$data_noticia' WHERE id = $editar_id");
